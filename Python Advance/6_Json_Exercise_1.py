...
while endGame != "quit":
    ...
    if (r.status_code != 200):
        ...
        print(html.unescape(question) + "\n")  # The questions come with HTML entities so for changing the HTML Code into Question
        ...
        user_answer = answers[int(user_answer)-1] # Here we use -1 because index starts with 0
